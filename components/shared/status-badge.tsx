...
const styles: Record<string, string> = {
  ...
  VISITED: "bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300",
  RETURNED: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300",
  ...
  MISSION_IGNITION: "bg-violet-50 text-violet-700 dark:bg-violet-950 dark:text-violet-300",
  WORKER_TRAINING: "bg-violet-50 text-violet-700 dark:bg-violet-950 dark:text-violet-300",
  WORKER: "bg-emerald-50 text-emerald-700 dark:bg-emerald-950 dark:text-emerald-300",
  LEADER: "bg-primary/10 text-primary",
  SUPER_ADMIN: "bg-primary/10 text-primary",
  ADMIN: "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-300",
  PASTOR: "bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300",
  ...
  JUNIOR: "bg-indigo-50 text-indigo-700 dark:bg-indigo-950 dark:text-indigo-300",
  MALE: "bg-sky-50 text-sky-700 dark:bg-sky-950 dark:text-sky-300",
  FEMALE: "bg-violet-50 text-violet-700 dark:bg-violet-950 dark:text-violet-300",
}
